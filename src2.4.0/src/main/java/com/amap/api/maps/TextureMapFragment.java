...
public class TextureMapFragment extends Fragment {
    ...
    public static native TextureMapFragment newInstance();
    ...
    public IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.b == null) {
            try {
                this.b = (IMapFragmentDelegate) oO0O000o.O000000o().O000000o(getActivity(), OOo000.O00000oO(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", cf.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
                if (this.b == null) {
                    this.b = (IMapFragmentDelegate) oO00o000.O000000o(getActivity(), OOo000.O00000oO(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", cf.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
                }
            } catch (Throwable unused) {
            }
            if (this.b == null) {
