...
public final class MarkerOptions implements Parcelable {
    ...
    public MarkerOptions angleOffset(float f) {
        this.angleOffset = f;
        return this;
    }
    ...
    public BitmapDescriptor getIcon() {
        return (this.bitmapDescriptors == null || this.bitmapDescriptors.size() == 0) ? null : (BitmapDescriptor) this.bitmapDescriptors.get(0);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        if (this.bitmapDescriptors != null && this.bitmapDescriptors.size() != 0) {
            parcel.writeParcelable((Parcelable) this.bitmapDescriptors.get(0), i);
        }
    }
