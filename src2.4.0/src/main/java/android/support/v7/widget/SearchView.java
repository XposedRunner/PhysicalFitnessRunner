...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private static class AutoCompleteTextViewReflector {
        ...
        L_0x003c:
            r2 = android.view.inputmethod.InputMethodManager.class;
            r3 = "showSoftInputUnchecked";
            r4 = 2;
            ...
            r0 = android.os.ResultReceiver.class;
            ...
            r0 = r6.showSoftInputUnchecked;	 Catch:{ NoSuchMethodException -> 0x0056 }
            r0.setAccessible(r1);	 Catch:{ NoSuchMethodException -> 0x0056 }
        L_0x0056:
            return;
            */
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            return (screenWidthDp < 960 || screenHeightDp < 720 || configuration.orientation != 2) ? (screenWidthDp >= SecExceptionCode.SEC_ERROR_SIGNATRUE || (screenWidthDp >= GlMapUtil.DEVICE_DISPLAY_DPI_XXHIGH && screenHeightDp >= GlMapUtil.DEVICE_DISPLAY_DPI_XHIGH)) ? 192 : GlMapUtil.DEVICE_DISPLAY_DPI_NORMAL : 256;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mVoiceWebSearchIntent.addFlags(AMapEngineUtils.MAX_P20_WIDTH);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(AMapEngineUtils.MAX_P20_WIDTH);
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        try {
            ...
            return createIntent(str2, columnString == null ? null : Uri.parse(columnString), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i, str);
