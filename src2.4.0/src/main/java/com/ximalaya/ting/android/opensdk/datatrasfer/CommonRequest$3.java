...
class CommonRequest$3 implements IHttpCallBack {
    final /* synthetic */ IDataCallBack val$callback;
    final /* synthetic */ CommonRequest$IRequestCallBack val$successCallBack;

    CommonRequest$3(CommonRequest$IRequestCallBack commonRequest$IRequestCallBack, IDataCallBack iDataCallBack) {
