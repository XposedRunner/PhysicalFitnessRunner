...
public class Toolbar extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(0, ViewCompat.getMeasuredState(this.mNavButtonView));
        } else {
            measuredWidth = 0;
            max = measuredWidth;
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(this.mCollapseButtonView));
        }
        ...
        if (shouldLayout(this.mMenuView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(this.mMenuView));
        } else {
            measuredWidth = 0;
        }
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(this.mExpandedActionView));
        }
        if (shouldLayout(this.mLogoView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(this.mLogoView));
        }
        i4 = getChildCount();
        max2 = max;
        max = i3;
        for (i3 = 0; i3 < i4; i3++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                ...
                combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(childAt));
            }
        }
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            combineMeasuredStates2 = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(this.mTitleTextView));
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            ...
            combineMeasuredStates2 = ViewUtils.combineMeasuredStates(i3, ViewCompat.getMeasuredState(this.mSubtitleTextView));
        } else {
            i3 = combineMeasuredStates2;
        }
        ...
        int i6 = i;
        currentContentInsetStart = ViewCompat.resolveSizeAndState(Math.max(max + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i6, ViewCompat.MEASURED_STATE_MASK & combineMeasuredStates2);
        measuredWidth = ViewCompat.resolveSizeAndState(Math.max(measuredWidth, getSuggestedMinimumHeight()), i2, combineMeasuredStates2 << 16);
        if (shouldCollapse()) {
            measuredWidth = 0;
        }
