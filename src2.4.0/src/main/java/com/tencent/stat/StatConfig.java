...
public class StatConfig {
            ...
            while (keys.hasNext()) {
                ...
                if (str.equalsIgnoreCase(Integer.toString(b.a))) {
                    ...
                    if (statReportStrategy != null) {
                        ...
                        stringBuilder.append("Change to ReportStrategy:");
    ...
    static void c(JSONObject jSONObject) {
        try {
            ...
            StatLogger statLogger = e;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("hibernateVer:");
            stringBuilder.append(string);
            stringBuilder.append(", current version:");
            stringBuilder.append(StatConstants.VERSION);
            statLogger.d(stringBuilder.toString());
            long b = k.b(string);
            if (k.b(StatConstants.VERSION) <= b) {
                ...
                stringBuilder.append("MTA has disable for SDK version of ");
                stringBuilder.append(string);
                stringBuilder.append(" or lower.");
                statLogger.warn(stringBuilder.toString());
            }
        } catch (JSONException unused) {
    ...
    public static void setStatSendStrategy(StatReportStrategy statReportStrategy) {
        ...
        StatLogger statLogger = e;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Change to statSendStrategy: ");
