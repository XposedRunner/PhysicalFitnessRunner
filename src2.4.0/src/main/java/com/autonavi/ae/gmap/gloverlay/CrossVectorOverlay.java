...
import com.amap.api.mapcore.util.O0000OOo.O000000o;
...
public class CrossVectorOverlay extends BaseMapOverlay<GLCrossVector, Object> implements O000000o {
    AVectorCrossAttr attr = null;
    private GenerateCrossImageListener imageListener;
    private boolean isImageMode = false;
    private O0000OOo pluginTexture;

    public CrossVectorOverlay(int i, Context context, ca caVar) {
        super(i, context, caVar);
    }

    private void drawVectorFailed(int i) {
        if (this.pluginTexture != null) {
            this.pluginTexture.O00000Oo();
        }
    ...
    private void initImageMode(int i, int i2) {
        if (this.pluginTexture == null) {
            this.pluginTexture = new O0000OOo(this.mMapView);
            this.pluginTexture.O000000o(this.imageListener);
            this.pluginTexture.O000000o((O000000o) this);
            this.pluginTexture.O00000Oo(this.attr.stAreaRect.width(), this.attr.stAreaRect.height());
        }
        ...
        if (bArr == null || this.attr == null) {
            ...
            if (this.isImageMode && this.imageListener != null) {
                this.mMapView.queueEvent(new Runnable() {
                    public void run() {
                        try {
                            if (CrossVectorOverlay.this.mGLOverlay != null && ((GLCrossVector) CrossVectorOverlay.this.mGLOverlay).isVisible() && CrossVectorOverlay.this.pluginTexture != null && !CrossVectorOverlay.this.pluginTexture.O00000o0()) {
                                CrossVectorOverlay.this.pluginTexture.O000000o(mapWidth, mapHeight);
                                CrossVectorOverlay.this.pluginTexture.O000000o();
                            }
                        } catch (Throwable th) {
                            ooOOOOoo.O00000o0(th, "CrossVectorOverlay", "setData");
                        }
                    }
                });
            }
