...
public class Md5Crypt {
    ...
    public static String apr1Crypt(byte[] bArr) {
        ...
        stringBuilder.append(APR1_PREFIX);
        stringBuilder.append(B64.getRandomSalt(8));
        return apr1Crypt(bArr, stringBuilder.toString());
    }
    ...
    public static String md5Crypt(byte[] bArr) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(MD5_PREFIX);
        stringBuilder.append(B64.getRandomSalt(8));
        return md5Crypt(bArr, stringBuilder.toString());
    }
    ...
    public static String md5Crypt(byte[] bArr, String str, String str2) {
        ...
        B64.b64from24bit(digest2[0], digest2[6], digest2[12], 4, stringBuilder4);
        B64.b64from24bit(digest2[1], digest2[7], digest2[13], 4, stringBuilder4);
        B64.b64from24bit(digest2[2], digest2[8], digest2[14], 4, stringBuilder4);
        B64.b64from24bit(digest2[3], digest2[9], digest2[15], 4, stringBuilder4);
        B64.b64from24bit(digest2[4], digest2[10], digest2[5], 4, stringBuilder4);
        B64.b64from24bit((byte) 0, (byte) 0, digest2[11], 2, stringBuilder4);
        md5Digest.reset();
        md5Digest2.reset();
