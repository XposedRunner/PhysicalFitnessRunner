...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new ContextThemeWrapper(this.mContext, typedValue.resourceId) : this.mContext).inflate(R.layout.abc_screen_toolbar, null);
    ...
    L_0x0019:
        ...
        r4 = android.support.v4.view.ViewConfigurationCompat.hasPermanentMenuKey(r4);
        if (r4 != 0) goto L_0x0047;
    L_0x0025:
        r4 = r3.mDecorContentParent;
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    ...
                    if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                        ...
                        if (layoutParams2 != null && layoutParams2.width == -1) {
                            ...
                            layoutParams = new LayoutParams(i, -2, panelFeatureState.x, panelFeatureState.y, 1002, 8519680, -3);
    ...
    L_0x0117:
        r8 = r7.mActionModeView;
        r1 = 0;
        android.support.v4.view.ViewCompat.setAlpha(r8, r1);
        r8 = r7.mActionModeView;
