            ...
            if (i == 5) {
                ...
                if (nextNonWhitespace2 != 44) {
                    if (nextNonWhitespace2 == 59) {
                        checkLenient();
                    } else if (nextNonWhitespace2 != SecExceptionCode.SEC_ERROR_INIT_PARSE_USER_CONFIG_ERROR) {
        ...
        if (nextNonWhitespace == 34) {
            ...
            if (!(nextNonWhitespace == 44 || nextNonWhitespace == 59)) {
                if (nextNonWhitespace == 91) {
                    ...
                    if (nextNonWhitespace != SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE) {
                        this.pos--;
                        i = peekKeyword();
                        if (i != 0) {
                            return i;
