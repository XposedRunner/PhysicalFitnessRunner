...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    private int mGravity = SecExceptionCode.SEC_ERROR_SET_GLOBAL_USER_DATA;
    private boolean mIsCircular;
    private final Paint mPaint = new Paint(3);
    private final Matrix mShaderMatrix = new Matrix();
    private int mTargetDensity = GlMapUtil.DEVICE_DISPLAY_DPI_NORMAL;
    ...
    public int getOpacity() {
        int i = -3;
        if (this.mGravity != SecExceptionCode.SEC_ERROR_SET_GLOBAL_USER_DATA || this.mIsCircular) {
            return -3;
        }
        Bitmap bitmap = this.mBitmap;
