        ...
        RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectHelper() {
            public void drawRoundRect(Canvas canvas, RectF rectF, float f, Paint paint) {
                ...
                if (f >= 1.0f) {
                    ...
                    canvas2.drawArc(CardViewGingerbread.this.sCornerRect, 180.0f, 90.0f, true, paint);
                    canvas2.translate(width, 0.0f);
                    canvas2.rotate(90.0f);
                    float f5 = 90.0f;
                    Paint paint2 = paint;
                    canvas2.drawArc(CardViewGingerbread.this.sCornerRect, 180.0f, 90.0f, true, paint2);
