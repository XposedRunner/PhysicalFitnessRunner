...
public final class c {
    ...
    public final String toString() {
        ...
        StringBuilder stringBuilder2 = new StringBuilder("[JHead] - len:");
        stringBuilder2.append(this.a);
        stringBuilder2.append(", version:");
        stringBuilder2.append(this.b);
        stringBuilder2.append(", command:");
        stringBuilder2.append(this.c);
        stringBuilder2.append(", rid:");
        stringBuilder2.append(this.d);
        if (this.g) {
            StringBuilder stringBuilder3 = new StringBuilder(", sid:");
