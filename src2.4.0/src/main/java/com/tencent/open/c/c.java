...
public class c extends b {
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        stringBuilder.append("-->dispatchKeyEvent, is device support: ");
        ...
        switch (keyCode) {
            ...
            default:
                ...
                if (SecureJsInterface.isPWDEdit) {
                    ...
                    if ((keyCode >= 33 && keyCode <= 95) || (keyCode >= 97 && keyCode <= SecExceptionCode.SEC_ERROR_INIT_PARSE_USER_CONFIG_ERROR)) {
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("-->create input connection, is edit: ");
        ...
        stringBuilder2.append("-->onCreateInputConnection, inputConn is ");
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("-->onKeyDown, is device support: ");
        stringBuilder.append(a);
        f.b("openSDK_LOG.SecureWebView", stringBuilder.toString());
        if (!a) {
