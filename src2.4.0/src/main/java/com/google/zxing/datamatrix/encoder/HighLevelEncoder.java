    ...
    static int lookAheadTest(CharSequence charSequence, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 == charSequence.length()) {
                ...
                return iArr[0] == findMinimums ? 0 : (minimumCount != 1 || bArr[5] <= (byte) 0) ? (minimumCount != 1 || bArr[4] <= (byte) 0) ? (minimumCount != 1 || bArr[2] <= (byte) 0) ? (minimumCount != 1 || bArr[3] <= (byte) 0) ? 1 : 3 : 2 : 4 : 5;
            } else {
                ...
                if (i4 >= 4) {
                    ...
                    if (iArr2[5] >= iArr2[0] && ((bArr2[1] + bArr2[2]) + bArr2[3]) + bArr2[4] != 0) {
                        ...
                        if (iArr2[1] + 1 < iArr2[0] && iArr2[1] + 1 < iArr2[5] && iArr2[1] + 1 < iArr2[4] && iArr2[1] + 1 < iArr2[2]) {
                            ...
                            if (iArr2[1] == iArr2[3]) {
                                for (i3 = (i3 + i4) + 1; i3 < charSequence.length(); i3++) {
