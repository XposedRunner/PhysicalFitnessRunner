...
public class SupportMapFragment extends Fragment {
    ...
    public static native SupportMapFragment newInstance();
    ...
    public IMapFragmentDelegate getMapFragmentDelegate(Context context) {
        if (this.b == null) {
            try {
                ...
                this.b = (IMapFragmentDelegate) oO0O000o.O000000o().O000000o(context2, OOo000.O00000oO(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", cf.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(0)});
                if (this.b == null) {
                    context2 = context;
                    this.b = (IMapFragmentDelegate) oO00o000.O000000o(context2, OOo000.O00000oO(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", cf.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(0)});
                }
            } catch (Throwable unused) {
            }
            if (this.b == null) {
