...
public class MapView extends FrameLayout {
    ...
    public IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.a == null) {
            try {
                this.a = (IMapFragmentDelegate) oO0O000o.O000000o().O000000o(getContext(), OOo000.O00000oO(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", cf.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(0)});
                if (this.a == null) {
                    this.a = (IMapFragmentDelegate) oO00o000.O000000o(getContext(), OOo000.O00000oO(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", cf.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(0)});
                }
            } catch (Throwable th) {
                th.printStackTrace();
            }
