...
public class ParticleOverlayOptions extends BaseOptions implements Parcelable, Cloneable {
    public static final Creator<ParticleOverlayOptions> CREATOR = new Creator<ParticleOverlayOptions>() {
        /* renamed from: a */
