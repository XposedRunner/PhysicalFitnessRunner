...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i5 = i & 7;
        i &= 112;
        i5 = i5 != 1 ? i5 != 5 ? rect.left : rect.right : rect.left + (rect.width() / 2);
    ...
    L_0x0142:
        ...
        r11 = r29;
        r0 = android.support.v4.view.ViewCompat.combineMeasuredStates(r11, r0);
        r3 = r0;
        r4 = r1;
    L_0x0172:
        r5 = r22 + 1;
    ...
    L_0x0178:
        ...
        r1 = r11 << 16;
        r2 = r33;
        r1 = android.support.v4.view.ViewCompat.resolveSizeAndState(r3, r2, r1);
        ...
        while (i < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted()) {
                    Behavior behavior = layoutParams.getBehavior();
                    if (behavior != null) {
                        i2 |= behavior.onNestedFling(this, childAt, view, f, f2, z);
                    }
                }
            }
            i++;
        ...
        while (i < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted()) {
                    Behavior behavior = layoutParams.getBehavior();
                    if (behavior != null) {
                        i2 |= behavior.onNestedPreFling(this, childAt, view, f, f2);
                    }
                }
            }
            i++;
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted()) {
                    ...
                    if (behavior != null) {
                        ...
                        i6 = i2 > 0 ? Math.max(i6, this.mTempIntPair[1]) : Math.min(i6, this.mTempIntPair[1]);
                        i3 = 1;
                    }
                }
            }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        r1 = r14.mBehaviorTouchView;
        r2 = 1;
        r3 = 0;
        if (r1 != 0) goto L_0x0011;
    L_0x000a:
        r1 = r14.performIntercept(r15, r2);
    ...
    L_0x0033:
        ...
        r13 = 0;
        r6 = r8;
        r5 = android.view.MotionEvent.obtain(r6, r8, r10, r11, r12, r13);
