...
public class TextInputLayout extends LinearLayout {
    ...
    private void setError(@Nullable final CharSequence charSequence, boolean z) {
        ...
        this.mErrorShown = TextUtils.isEmpty(charSequence) ^ 1;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mHintEnabled && this.mEditText != null) {
            ...
            i = rect.left + this.mEditText.getCompoundPaddingLeft();
            i3 = rect.right - this.mEditText.getCompoundPaddingRight();
            this.mCollapsingTextHelper.setExpandedBounds(i, rect.top + this.mEditText.getCompoundPaddingTop(), i3, rect.bottom - this.mEditText.getCompoundPaddingBottom());
    ...
    public void updateLabelState(boolean z, boolean z2) {
        ...
        if (i != 0 || (isEnabled() && (arrayContains || isEmpty != 0))) {
