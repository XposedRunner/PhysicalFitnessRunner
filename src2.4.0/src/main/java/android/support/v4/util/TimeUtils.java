...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        printField = printField(cArr, i5, 'h', printField, printField != i11, i2 != 0 ? 2 : 0);
        printField = printField(cArr, i3, 'm', printField, printField != i11, i2 != 0 ? 2 : 0);
        printField = printField(cArr, i7, 's', printField, printField != i11, i2 != 0 ? 2 : 0);
