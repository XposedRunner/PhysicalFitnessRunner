...
public final class CameraPosition implements Parcelable {
    ...
    public static final class Builder {
        ...
        public CameraPosition build() {
            ...
            try {
                ...
                ooOOOOoo.O00000o0(th, CameraPosition.CLASSNAME, str);
                return null;
            }
        }
    ...
    public CameraPosition(LatLng latLng, float f, float f2, float f3) {
        ...
        if (latLng != null) {
            this.isAbroad = OOOO0O.O000000o(latLng.latitude, latLng.longitude) ^ 1;
        } else {
            this.isAbroad = false;
        }
    }
    ...
    public String toString() {
        return OOo000.O000000o(OOo000.O000000o("target", this.target), OOo000.O000000o("zoom", Float.valueOf(this.zoom)), OOo000.O000000o("tilt", Float.valueOf(this.tilt)), OOo000.O000000o("bearing", Float.valueOf(this.bearing)));
    }
