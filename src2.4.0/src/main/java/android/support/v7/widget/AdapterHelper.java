...
class AdapterHelper implements Callback {
    ...
    private void applyUpdate(UpdateOp updateOp) {
        ...
        while (i3 < i2) {
            if (this.mCallback.findViewHolder(i3) != null || canFindInPreLayout(i3)) {
                if (i4 == 0) {
                    dispatchAndUpdateViewHolders(obtainUpdateOp(4, i5, i, updateOp.payload));
                    i5 = i3;
                    i = 0;
                }
                i4 = 1;
                ...
                if (i4 == 1) {
                    postponeAndUpdateViewHolders(obtainUpdateOp(4, i5, i, updateOp.payload));
                    i5 = i3;
                    i = 0;
                }
                i4 = 0;
        ...
        if (i != updateOp.itemCount) {
            ...
            recycleUpdateOp(updateOp);
            updateOp = obtainUpdateOp(4, i5, i, obj);
        }
        if (i4 == 0) {
            dispatchAndUpdateViewHolders(updateOp);
        } else {
