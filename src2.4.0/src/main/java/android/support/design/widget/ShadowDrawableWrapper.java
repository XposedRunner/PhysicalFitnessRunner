...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildShadowCorners() {
        ...
        if (f > 0.0f) {
            ...
            Shader radialGradient = new RadialGradient(0.0f, 0.0f, f, new int[]{0, this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, fArr, TileMode.CLAMP);
            paint.setShader(shader);
        }
        Paint paint2 = this.mEdgeShadowPaint;
        float f4 = rectF.top;
        paint2.setShader(new LinearGradient(0.0f, f4, 0.0f, rectF2.top, new int[]{this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
    ...
    private void drawShadow(Canvas canvas) {
        ...
        Object obj2 = this.mContentBounds.height() - f6 > 0.0f ? 1 : null;
        float f7 = f5 / ((this.mRawShadowSize - (this.mRawShadowSize * 0.5f)) + f5);
        float f8 = f5 / ((this.mRawShadowSize - (this.mRawShadowSize * 0.25f)) + f5);
        float f9 = f5 / ((this.mRawShadowSize - (this.mRawShadowSize * 1.0f)) + f5);
        ...
        if (obj != null) {
            ...
            i2 = save;
            f2 = f8;
            canvas2.drawRect(0.0f, f4, this.mContentBounds.width() - f6, -this.mCornerRadius, this.mEdgeShadowPaint);
        } else {
            i = save2;
            f = f9;
            i2 = save;
        ...
        if (obj != null) {
            ...
            f3 = f2;
            f2 = f8;
            canvas2.drawRect(0.0f, f4, this.mContentBounds.width() - f6, (-this.mCornerRadius) + this.mShadowSize, this.mEdgeShadowPaint);
        } else {
            f3 = f2;
            f2 = f8;
        }
        ...
        if (obj2 != null) {
            ...
            canvas2.drawRect(0.0f, f4, this.mContentBounds.height() - f6, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
