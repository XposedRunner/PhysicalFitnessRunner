...
public class d {
    ...
    public void a(int i, String str, String str2, String str3, String str4, Long l, int i2, int i3, String str5) {
        ...
        g.a().a(stringBuffer.toString(), Constants.HTTP_GET, j.a(String.valueOf(i), String.valueOf(i2), String.valueOf(elapsedRealtime), String.valueOf(i3), str, str6, str3, str4, str5), true);
    }
