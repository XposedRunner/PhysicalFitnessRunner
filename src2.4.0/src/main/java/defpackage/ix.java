...
/* compiled from: ConcernListPImpl */
/* renamed from: ix */
public class ix extends iz<O00000Oo> implements O000000o<FansListBean> {
    ...
    class 1 extends fw<FansListBean> {
        ...
        1(ix ixVar, Context context, int i, List list, Context context2) {
        }
    ...
    public ix(O00000Oo o00000Oo, Context context) {
    }
    ...
    public void O00000Oo(android.content.Context r6) {
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ix.O00000Oo(android.content.Context):void");
    }
