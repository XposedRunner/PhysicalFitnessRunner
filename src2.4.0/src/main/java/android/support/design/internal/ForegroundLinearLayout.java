...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mForegroundGravity = SecExceptionCode.SEC_ERROR_SET_GLOBAL_USER_DATA;
    ...
    public void setForeground(Drawable drawable) {
        if (this.mForeground != drawable) {
            ...
            if (drawable != null) {
                ...
                if (this.mForegroundGravity == SecExceptionCode.SEC_ERROR_SET_GLOBAL_USER_DATA) {
    ...
    public void setForegroundGravity(int i) {
        if (this.mForegroundGravity != i) {
            ...
            if (this.mForegroundGravity == SecExceptionCode.SEC_ERROR_SET_GLOBAL_USER_DATA && this.mForeground != null) {
