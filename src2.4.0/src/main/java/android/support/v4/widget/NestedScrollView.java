        ...
        switch (actionMasked) {
            ...
            case 2:
                ...
                if (findPointerIndex != -1) {
                    ...
                    int i = this.mLastMotionY - actionMasked;
                    ...
                    int i2 = i;
                    if (this.mIsBeingDragged) {
                        this.mLastMotionY = actionMasked - this.mScrollOffset[1];
                        int scrollY = getScrollY();
                        int scrollRange = getScrollRange();
                        actionMasked = getOverScrollMode();
                        int i3 = (actionMasked == 0 || (actionMasked == 1 && scrollRange > 0)) ? 1 : 0;
                        int i4 = scrollRange;
                        int i5 = i2;
                        ...
                        if (!dispatchNestedScroll(0, i, 0, i5 - i, this.mScrollOffset)) {
                            if (i3 != 0) {
                                ensureGlows();
                                actionMasked = scrollY + i5;
                                if (actionMasked < 0) {
                                    this.mEdgeGlowTop.onPull(((float) i5) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                    if (!this.mEdgeGlowBottom.isFinished()) {
                                        this.mEdgeGlowBottom.onRelease();
                                    }
                                } else if (actionMasked > i4) {
                                    this.mEdgeGlowBottom.onPull(((float) i5) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                    if (!this.mEdgeGlowTop.isFinished()) {
                                        this.mEdgeGlowTop.onRelease();
                                    }
                                }
