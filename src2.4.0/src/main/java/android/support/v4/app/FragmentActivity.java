...
public class FragmentActivity extends BaseFragmentActivityJB implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    private static String viewToString(View view) {
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || resources == null)) {
                String str;
                visibility = ViewCompat.MEASURED_STATE_MASK & id;
                if (visibility == 16777216) {
                    str = "android";
                } else if (visibility != 2130706432) {
                    try {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        dumpViewHierarchy(stringBuilder3.toString(), printWriter, getWindow().getDecorView());
    }
    ...
    public boolean onMenuItemSelected(int i, MenuItem menuItem) {
        return super.onMenuItemSelected(i, menuItem) ? true : i != 0 ? i != 6 ? false : this.mFragments.dispatchContextItemSelected(menuItem) : this.mFragments.dispatchOptionsItemSelected(menuItem);
    }
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intentSender, int i, @Nullable Intent intent, int i2, int i3, int i4, Bundle bundle) throws SendIntentException {
        ...
        if (i5 == -1) {
            ...
            ActivityCompat.startIntentSenderForResult(this, intentSender, ((allocateRequestIndex(fragment) + 1) << 16) + (SupportMenu.USER_MASK & i5), intent, i2, i3, i4, bundle);
            this.mStartedIntentSenderFromFragment = false;
        }
    }
