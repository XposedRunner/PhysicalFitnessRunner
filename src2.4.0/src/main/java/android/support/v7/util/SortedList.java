...
public class SortedList<T> {
    ...
    private void merge(T[] tArr, int i) {
        ...
        while (true) {
            ...
            if (this.mOldDataStart == this.mOldDataSize) {
                ...
                System.arraycopy(this.mOldData, this.mOldDataStart, this.mData, this.mMergedSize, i3);
                this.mMergedSize += i3;
                return;
            } else {
    ...
    public int indexOf(T t) {
        if (this.mOldData != null) {
            ...
            return findIndexOf2 != -1 ? (findIndexOf2 - this.mOldDataStart) + this.mMergedSize : -1;
        } else {
