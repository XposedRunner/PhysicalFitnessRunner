...
public final class Marker extends BasePointOverlay {
    ...
    public float getAlpha() {
        ...
        return iMarkerAction != null ? iMarkerAction.getAlpha() : 1.0f;
    }
    ...
    public int getDisplayLevel() {
        IMarkerAction iMarkerAction = this.markerDelegate.getIMarkerAction();
        return iMarkerAction != null ? iMarkerAction.getDisplayLevel() : 5;
    }
    ...
    public MarkerOptions getOptions() {
        IMarkerAction iMarkerAction = this.markerDelegate.getIMarkerAction();
        return iMarkerAction != null ? iMarkerAction.getOptions() : null;
    }
    ...
    public boolean isClickable() {
        IMarkerAction iMarkerAction = this.markerDelegate.getIMarkerAction();
        return iMarkerAction != null ? iMarkerAction.isClickable() : false;
    }
    ...
    public boolean isInfoWindowAutoOverturn() {
        IMarkerAction iMarkerAction = this.markerDelegate.getIMarkerAction();
        return iMarkerAction != null ? iMarkerAction.isInfoWindowAutoOverturn() : false;
    }

    public boolean isInfoWindowEnable() {
        IMarkerAction iMarkerAction = this.markerDelegate.getIMarkerAction();
        return iMarkerAction != null ? iMarkerAction.isInfoWindowEnable() : false;
    }
