...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (findParentViewForSubmenu != null) {
            ...
            horizontalOffset = (this.mDropDownGravity & 5) == 5 ? z ? horizontalOffset + measureIndividualMenuWidth : horizontalOffset - findParentViewForSubmenu.getWidth() : z ? horizontalOffset + findParentViewForSubmenu.getWidth() : horizontalOffset - measureIndividualMenuWidth;
            createPopupWindow.setHorizontalOffset(horizontalOffset);
