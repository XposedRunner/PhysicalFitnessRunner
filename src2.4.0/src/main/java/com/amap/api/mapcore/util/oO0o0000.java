...
public class oO0o0000 implements Closeable {
    ...
    public oO0o0000(InputStream inputStream, int i, Charset charset) {
        if (inputStream == null || charset == null) {
            throw new NullPointerException();
        } else if (i < 0) {
            throw new IllegalArgumentException("capacity <= 0");
        } else if (charset.equals(oOo00o00.O000000o)) {
    ...
    public oO0o0000(InputStream inputStream, Charset charset) {
        ...
        synchronized (this.O000000o) {
            ...
            AnonymousClass1 anonymousClass1 = new ByteArrayOutputStream((this.O00000oO - this.O00000o) + 80) {
                public String toString() {
                    ...
                    try {
                        return new String(this.buf, 0, i, oO0o0000.this.O00000Oo.name());
