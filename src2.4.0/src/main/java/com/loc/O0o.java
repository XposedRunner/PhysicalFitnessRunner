...
public final class O0o {
    private static Object O000000o(Object obj, Class<?> cls, String str, Class[] clsArr, Object[] objArr) {
        try {
    ...
    public static Object O000000o(Object obj, String str, Class[] clsArr, Object[] objArr) {
        try {
            return O000000o(obj, obj.getClass(), str, clsArr, objArr);
        } catch (Throwable th) {
            th.printStackTrace();
            return null;
        }
    ...
    public static Object O000000o(String str, Class<?>[] clsArr, Object[] objArr) throws Exception {
