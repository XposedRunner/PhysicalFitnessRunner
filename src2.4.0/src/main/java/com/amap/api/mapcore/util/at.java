...
public final class at implements AMapLocationListener {
    public Inner_3dMap_locationListener O000000o = null;

    private static void O000000o(Inner_3dMap_location inner_3dMap_location, AMapLocation aMapLocation) {
        try {
            ...
            bp.O000000o(th, "LocationListener", "converterLocation");
        }
    }

    public final void O000000o(Inner_3dMap_locationListener inner_3dMap_locationListener) {
        this.O000000o = inner_3dMap_locationListener;
    }

    public final void onLocationChanged(AMapLocation aMapLocation) {
        try {
            Inner_3dMap_location inner_3dMap_location = new Inner_3dMap_location("");
            O000000o(inner_3dMap_location, aMapLocation);
            if (this.O000000o != null) {
                this.O000000o.onLocationChanged(inner_3dMap_location);
            }
        } catch (Throwable th) {
            bp.O000000o(th, "LocationListener", "onLocationChanged");
        }
    }
}
