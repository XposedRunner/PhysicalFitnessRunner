...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        private static String pathOldToNew(String str) {
            ...
            if (lastIndexOf == -1) {
                str2 = WXMediaMessage.TAG;
                stringBuilder = new StringBuilder("pathOldToNew fail, invalid pos, oldPath = ");
                stringBuilder.append(str);
                Log.e(str2, stringBuilder.toString());
                return str;
            }
            stringBuilder = new StringBuilder("com.tencent.mm.opensdk.modelmsg");
