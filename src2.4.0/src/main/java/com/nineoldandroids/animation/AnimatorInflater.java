...
public class AnimatorInflater {
    ...
    public static com.nineoldandroids.animation.Animator loadAnimator(android.content.Context r4, int r5) throws android.content.res.Resources.NotFoundException {
        ...
        r4 = createAnimatorFromXml(r4, r1);	 Catch:{ XmlPullParserException -> 0x0019, IOException -> 0x0016, all -> 0x0013 }
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attributeSet, ValueAnimator valueAnimator) throws NotFoundException {
        ...
        if (i == 0) {
            ...
            float dimension3 = i3 == 5 ? obtainStyledAttributes.getDimension(5, 0.0f) : obtainStyledAttributes.getFloat(5, 0.0f);
            if (i4 != 0) {
                dimension2 = i5 == 5 ? obtainStyledAttributes.getDimension(6, 0.0f) : obtainStyledAttributes.getFloat(6, 0.0f);
                r6 = new float[2];
                i = 0;
                r6[0] = dimension3;
                r6[1] = dimension2;
                ...
                i = 0;
                valueAnimator2.setFloatValues(dimension3);
            }
        } else {
            i = 0;
            dimension2 = i5 == 5 ? obtainStyledAttributes.getDimension(6, 0.0f) : obtainStyledAttributes.getFloat(6, 0.0f);
