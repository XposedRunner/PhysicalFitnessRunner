...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        i2 = Math.abs(i2);
        return Math.min(i2 > 0 ? 4 * Math.round(1000.0f * Math.abs(f / ((float) i2))) : (int) (((((float) Math.abs(i)) / ((float) i3)) + 1.0f) * 256.0f), 600);
    }
    ...
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r18) {
        ...
        r0 = r17;
        r1 = r18;
        r2 = android.support.v4.view.MotionEventCompat.getActionMasked(r18);
        r3 = android.support.v4.view.MotionEventCompat.getActionIndex(r18);
